...
class TimeSeries2SeriesInner(BaseModel):
    """
    TimeSeries2SeriesInner
    """
    values: Optional[List[TimeSeries2SeriesInnerValuesInner]] = None
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "values": [TimeSeries2SeriesInnerValuesInner.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None
        })
        return _obj
