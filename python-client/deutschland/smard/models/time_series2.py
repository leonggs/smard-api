...
class TimeSeries2(BaseModel):
    """
    TimeSeries2
    """
    meta_data: Optional[TimeSeriesMetaData] = None
    series: Optional[List[TimeSeries2SeriesInner]] = None
    __properties: ClassVar[List[str]] = ["meta_data", "series"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "meta_data": TimeSeriesMetaData.from_dict(obj.get("meta_data")) if obj.get("meta_data") is not None else None,
            "series": [TimeSeries2SeriesInner.from_dict(_item) for _item in obj.get("series")] if obj.get("series") is not None else None
        })
        return _obj
