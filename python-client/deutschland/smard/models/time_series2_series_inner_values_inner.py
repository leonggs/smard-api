...
class TimeSeries2SeriesInnerValuesInner(BaseModel):
    """
    TimeSeries2SeriesInnerValuesInner
    """
    timestamp: Optional[Union[StrictFloat, StrictInt]] = None
    versions: Optional[List[TimeSeries2SeriesInnerValuesInnerVersionsInner]] = None
    __properties: ClassVar[List[str]] = ["timestamp", "versions"]
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [TimeSeries2SeriesInnerValuesInnerVersionsInner.from_dict(_item) for _item in obj.get("versions")] if obj.get("versions") is not None else None
        })
        return _obj
